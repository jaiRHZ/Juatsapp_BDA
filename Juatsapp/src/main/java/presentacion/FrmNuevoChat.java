...
public class FrmNuevoChat extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(225, 225, 218));

        jLabel11.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(7, 94, 84));
        jLabel11.setText("Nombre");

        btnAceptarChat.setBackground(new java.awt.Color(52, 183, 241));
    ...
    private void btnAceptarChatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarChatActionPerformed
        ...
        fachadaDAO.createChat(chat);
        System.out.println(usuario);
        System.out.println(fachadaDAO.readUsuario(usuario));
        
        System.out.println(fachadaDAO.readAllUsuario().get(0));
